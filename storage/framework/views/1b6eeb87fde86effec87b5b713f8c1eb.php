...
$(document).ready(function () {
    ...
    var satuanTable = $('#satuan').DataTable({
        ...
        $('#tambahForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?php echo e(route('satuan.store')); ?>',
                method: 'POST',
                data: $(this).serialize(),
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        filterForm.addEventListener('submit', function(event) {
            ...
            const url = "<?php echo e(route('paket.index')); ?>?from_date=" + fromDateString + "&to_date=" + toDateString;
...
<?php /**PATH D:\UdaCoding\Codingan\Task 9\laundryy\resources\views/atribut/footer.blade.php ENDPATH**/ ?>
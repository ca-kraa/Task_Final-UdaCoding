    ...
    <div class="sidebar">
      ...
      <nav class="mt-2 ">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('satuan.index')); ?>" class="nav-link">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('paket.index')); ?>" class="nav-link">
...
<?php /**PATH D:\UdaCoding\Codingan\Task 9\laundryy\resources\views/atribut/sidebar.blade.php ENDPATH**/ ?>